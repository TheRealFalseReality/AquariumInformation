...
class SalinityMethods(
	...
	fun calculateSpecificGravity(): String {
		val aA = 8.24493e-1 - 4.0899e-3 * testWaterTemperature + 7.6438e-5 * testWaterTemperature * testWaterTemperature -
		...
		val bB = -5.72466e-3 + 1.0227e-4 * testWaterTemperature - 1.6546e-6 * testWaterTemperature * testWaterTemperature
		val cC = 4.8314e-4
		val rROo = 999.842594 + 6.793952e-2 * testWaterTemperature - 9.095290e-3 * testWaterTemperature *
		...
		val rROoTD = 999.842594 + 6.793952e-2 * pureWaterTemperature - 9.095290e-3 * pureWaterTemperature *
	...
	fun calculateSalinity(): String {
		val ppt = tds * 1240.63326 + testWaterTemperature * -3.26377 + tds * testWaterTemperature * 3.20800 + tds *
	...
	fun calculateDensityPPT(): String {
		val aB = 8.24493e-1 - 4.0899e-3 * testWaterTemperature + 7.6438e-5 * testWaterTemperature * testWaterTemperature -
				8.2467e-7 * testWaterTemperature * testWaterTemperature * testWaterTemperature + 5.3875e-9 * testWaterTemperature *
				testWaterTemperature * testWaterTemperature * testWaterTemperature
		val bC = -5.72466e-3 + 1.0227e-4 * testWaterTemperature - 1.6546e-6 * testWaterTemperature * testWaterTemperature
		val cD = 4.8314e-4
		val rOO = 999.842594 + 6.793952e-2 * testWaterTemperature - 9.095290e-3 * testWaterTemperature * testWaterTemperature
	...
	fun calculateDensitySG(): String {
		val rOoTDc = 999.842594 + 6.793952e-2 * pureWaterTemperature - 9.095290e-3 * pureWaterTemperature *
				pureWaterTemperature + 1.001685e-4 * pureWaterTemperature * pureWaterTemperature * pureWaterTemperature -
				1.120083e-6 * pureWaterTemperature * pureWaterTemperature * pureWaterTemperature * pureWaterTemperature +
				6.536332e-9 * pureWaterTemperature * pureWaterTemperature * pureWaterTemperature * pureWaterTemperature *
				pureWaterTemperature
