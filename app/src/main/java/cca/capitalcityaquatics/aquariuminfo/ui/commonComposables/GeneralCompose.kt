...
fun ReviewApp() {
	ContentBorder(
		...
		Column(
			modifier = Modifier
				.clickable { uriHandler.openUri("https://play.google.com/store/apps/details?id=cca.capitalcityaquatics.aquariuminfo&hl=en_US&pli=1") },
...
//	Icon(
//		painter = painterResource(id = R.drawable.rate_review_48px),
